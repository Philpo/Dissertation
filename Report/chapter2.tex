...
\\The discretisation of the cloth has a direct affect on the performance of the simulation; \textcite{Volino2001} have this to be of order O($n^{3}$). Hence, there is a trade off to be made between accuracy and performance when using discrete models, depending on the use-case.
