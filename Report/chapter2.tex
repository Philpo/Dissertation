...
\begin{figure}
\centering
\subfigure[Super-elasticity effect]{\label{fig:super-elasticity}\includegraphics[width=60mm]{Figures/super_elasticity.png}}
...
\\However, if the stiffness of the springs is constant throughout the simulation then $\bigg(I - \frac{\Delta t^{2}}{m}H\bigg)^{-1}$ can be precomputed, giving performance gains.